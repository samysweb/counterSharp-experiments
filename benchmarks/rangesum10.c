// amh: 2^160 (79 sec, 97.7 MB)
// asm: 2^160 (65 sec, 119.6 MB)
// ash: 65 x 2^123 (10029.7, 268.4 MB)
/*
...
int testfun (int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, int x9, int x10)
{
  int x[N];
  x[0]=x1;
  x[1]=x2;

...
exec_bench(){
	...
	for num in 01 02 03 04 05; do
		...
		resultDir=$resultDirOverall/$num/approxmc
		...
		echo "** CON **"
		echo "** CON **" >&2
		chrt -b 0 runlim -r 300 -s 2048 approxmc --sparse 1 -s $num $dataDir/con.dimacs
		echo "** AMM **"
		echo "** AMM **" >&2
		chrt -b 0 runlim -r 300 -s 2048 approxmc --sparse 1 -s $num $dataDir/amm.dimacs
		echo "** AMH **"
		echo "** AMH **" >&2
		chrt -b 0 runlim -r 300 -s 2048 approxmc --sparse 1 -s $num $dataDir/amh.dimacs
		echo "** ASM **"
		echo "** ASM **" >&2
		chrt -b 0 runlim -r 300 -s 2048 approxmc --sparse 1 -s $num $dataDir/asm.dimacs
		echo "** ASH **"
		echo "** ASH **" >&2
		chrt -b 0 runlim -r 300 -s 2048 approxmc --sparse 1 -s $num $dataDir/ash.dimacs

...
RUN git clone https://github.com/msoos/cryptominisat && cd cryptominisat && git checkout 716b89b && mkdir build && cd build && cmake .. && make && make install && cd ../..
RUN git clone https://github.com/meelgroup/arjun && cd arjun && git checkout 416b100 && mkdir build && cd build && cmake .. && make && make install && cd ../..
RUN git clone https://github.com/meelgroup/approxmc/ && cd approxmc && git checkout efa1667 && mkdir build && cd build && cmake .. && make && make install && cd ../../
